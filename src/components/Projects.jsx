...
const Projects = () => {
  ...
  description: "A web-based fruit quality analysis system that detects fruit type, ripeness level, and possible disease or damage using image processing and computer vision.",

  year: "2026",

  tags: ["Python", "Flask", "OpenCV", "NumPy", "HTML", "CSS", "JavaScript"],

  image: proj2Img,

  features: [

    "Fruit type classification from uploaded images",

    "Ripeness detection for different fruits",

    "Disease and damage detection",

    "Image-based fruit quality analysis",

    "Scan history stored using SQLite"

  ],

  githubLink: "https://github.com/Janhavi315/fruit-ripening-detection-system.git"
},
    {
